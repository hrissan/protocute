...
struct CodeGenerator {
	...
	explicit CodeGenerator(const std::string & only_name, const std::string & cpp_out_path):hpp(cpp_out_path + "/" + only_name + ".hpp"), cpp(cpp_out_path + "/" + only_name + ".cpp") {
		hpp << boast;
		hpp << "#include <string>\n";
		hpp << "#include <vector>\n";
		hpp << "#include <cstdint>\n\n";
